...
ggplot(combined_plot_data, aes(x=xvals)) +
  geom_ribbon(aes(ymin=lower,ymax=upper, fill= model_type), alpha=0.25) +
...
ggsave('outputs/figures/figure.1b.png', width = 13.5, height = 11)
...
ggsave('outputs/figures/figure.2b.png', width = 13.5, height = 11)
